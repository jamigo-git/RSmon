...
def installation_card(model, SN):
    ...
    btn_wr = Button(window_card, text="Отправить", command = lambda: SUBD_push(window_card, text_wr, SN, combo, sel.get()))
...
def SUBD_push(window_card, text_wr, SN, combo, alarms):
    print(alarms)
    try:
        # Подключение к БД
...
HX8100_3_PC = Button(lbl_HX8100_3, text="ПК", width = 3, command = lambda: PC_card('PC1'), bg = alarm_color)
...
HX8100_2_PC = Button(lbl_HX8100_2, text="ПК", width = 3, command = lambda: PC_card('PC2'), bg = alarm_color)
...
SY8125_1_PC = Button(lbl_SY8125_1, text="ПК", width = 3, command = lambda: PC_card('PC3'), bg = alarm_color)
...
SY8125_2_PC = Button(lbl_SY8125_2, text="ПК", width = 3, command = lambda: PC_card('PC4'), bg = alarm_color)
...
UAPS1M_6_PC = Button(lbl_UAPS1M_6, text="ПК", width = 3, command = lambda: PC_card('PC6'), bg = alarm_color)
...
UAPS1M_7_PC = Button(lbl_UAPS1M_7, text="ПК", width = 3, command = lambda: PC_card('PC7'), bg = alarm_color)
...
UAPS1M_8_PC = Button(lbl_UAPS1M_8, text="ПК", width = 3, command = lambda: PC_card('PC8'), bg = alarm_color)
...
UAPS1M_9_PC = Button(lbl_UAPS1M_9, text="ПК", width = 3, command = lambda: PC_card('PC9'), bg = alarm_color)
...
HX8300_10_PC = Button(lbl_HX8300_10, text="ПК", width = 3, command = lambda: PC_card('PC10'), bg = alarm_color)
...
HX8300_11_PC = Button(lbl_HX8300_11, text="ПК", width = 3, command = lambda: PC_card('PC11'), bg = alarm_color)
...
CL3005_1_PC = Button(lbl_CL3005_1, text="ПК", width = 3, command = lambda: PC_card('PC12'), bg = alarm_color)
...
Hovertip(CL3005_1_PC, ['Windows 7', '192.168.0.185'])
...
CL3005_2_PC = Button(lbl_CL3005_2, text="ПК", width = 3, command = lambda: PC_card('PC13'), bg = alarm_color)
CL3005_2_PC.place(x=200, y=0)
Hovertip(CL3005_2_1, ['CL3005-24', ' SN3042'])
Hovertip(CL3005_2_1, ['CL3005-24', ' SN3042'])
Hovertip(CL3005_2_ST, ['CL3005-24', ' SN3042'])
Hovertip(CL3005_2_PC, ['Windows 7', '192.168.0.253'])
...
CL1001_1_PC = Button(lbl_CL1001_1, text="ПК", width = 3, command = lambda: PC_card('PC14'), bg = alarm_color)
CL1001_1_PC.place(x=10, y=30)
Hovertip(CL1001_1_1, ['CL3005-24', ' SN1009'])
Hovertip(CL1001_1_ST, ['CL3005-24', ' SN1009'])
Hovertip(CL1001_1_PC, ['Windows XP', '192.168.0.201'])
...
CL1001_2_PC = Button(lbl_CL1001_2, text="ПК", width = 3, command = lambda: PC_card('PC15'), bg = alarm_color)
CL1001_2_PC.place(x=110, y=0)
Hovertip(CL1001_2_1, ['CL3005-24', ' SN1008'])
Hovertip(CL1001_2_ST, ['CL3005-24', ' SN1008'])
Hovertip(CL1001_2_PC, ['Windows XP', '192.168.0.47'])
...
SY8125_3_PC = Button(lbl_SY8125_3, text="ПК", width = 3, command = lambda: PC_card('PC16'), bg = alarm_color)
...
SY8125_4_PC = Button(lbl_SY8125_4, text="ПК", width = 3, command = lambda: PC_card('PC17'), bg = alarm_color)
...
SY8125_5_PC = Button(lbl_SY8125_5, text="ПК", width = 3, command = lambda: PC_card('PC18'), bg = alarm_color)
...
SY8125_6_PC = Button(lbl_SY8125_6, text="ПК", width = 3, command = lambda: PC_card('PC19'), bg = alarm_color)
...
CL3005_3_PC = Button(lbl_CL3005_3, text="ПК", width = 3, command = lambda: PC_card('PC20'), bg = alarm_color)
...
Hovertip(CL3005_3_PC, ['Windows 7', '192.168.0.14'])
...
CL3005_4_PC = Button(lbl_CL3005_4, text="ПК", width = 3, command = lambda: PC_card('PC21'), bg = alarm_color)
...
Hovertip(CL3005_4_PC, ['Windows 7', '192.168.0.13'])
...
CL3005_5_PC = Button(lbl_CL3005_5, text="ПК", width = 3, command = lambda: PC_card('PC22'), bg = alarm_color)
...
Hovertip(CL3005_5_PC, ['Windows XP', '192.168.0.200'])
...
CL1001_3_PC = Button(lbl_CL1001_2, text="ПК", width = 3, command = lambda: PC_card('PC23'), bg = alarm_color)
...
Hovertip(CL1001_3_PC, ['Windows 7', '192.168.0.100'])
...
CL1005_1_PC = Button(lbl_CL1005_1, text="ПК", width = 3, command = lambda: PC_card('PC24'), bg = alarm_color)
...
Hovertip(CL1005_1_PC, ['Windows XP', '192.168.0.245'])
...
CL3005_6_PC = Button(lbl_CL3005_6, text="ПК", width = 3, command = lambda: PC_card('PC25'), bg = alarm_color)
...
Hovertip(CL3005_6_PC, ['Windows 7', '192.168.0.247'])
...
SY8126_1_PC = Button(lbl_SY8126_1, text="ПК", width = 3, command = lambda: PC_card('PC26'), bg = alarm_color)
...
SY8126_2_PC = Button(lbl_SY8126_2, text="ПК", width = 3, command = lambda: PC_card('PC27'), bg = alarm_color)
...
SY8126_3_PC = Button(lbl_SY8126_3, text="ПК", width = 3, command = lambda: PC_card('PC28'), bg = alarm_color)
...
SY8126_2_ST.place(x=200, y=30)
SY8126_2_PC = Button(lbl_SY8126_2, text="ПК", width = 3, command = lambda: PC_card('PC29'), bg = alarm_color)
SY8126_2_PC.place(x=200, y=0)
...
CL3005_7_PC = Button(lbl_CL3005_7, text="ПК", width = 3, command = lambda: PC_card('PC30'), bg = alarm_color)
...
Hovertip(CL3005_7_PC, ['Windows 7', '192.168.0.180'])
...
CL3005_8_PC = Button(lbl_CL3005_8, text="ПК", width = 3, command = lambda: PC_card('PC31'), bg = alarm_color)
...
Hovertip(CL3005_8_PC, ['Windows 7', '192.168.0.111'])

#Элементы стенда №31 Merkury_210 SN025
alarm_color = button_color('025')
lbl_Merkury_210 = LabelFrame(window, text = "31")
...
#Элементы стенда №32 Merkury_210 SN018
