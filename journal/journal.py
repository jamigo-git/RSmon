...
def comments(model, SN):
    try:
        ...
        print("Не удалось подключиться к базе денных")
    ...
    try:
       # Считывание комментариев по заданному SN
        ...
        if SN == "ALL":
            ...
            cur.execute("SELECT date, time, author, commentary FROM public.comments WHERE serial_number = \'%s\' ORDER BY date DESC;" %SN)
        rows = cur.fetchall()
...
HX8100_3_1 = Button(lbl_HX8100_3, text="1-48", width = 10, command = lambda: installation_card('HX8100','080798', '1'), bg = alarm_color)
HX8100_3_1.place(x=10, y=0)
HX8100_3_2 = Button(lbl_HX8100_3, text="49-96", width = 10, command = lambda: installation_card('HX8100','080798', '1'), bg = alarm_color)
HX8100_3_2.place(x=105, y=0)
HX8100_3_PC = Button(lbl_HX8100_3, text="ПК", width = 3, command = lambda: PC_card('PC1', '192.168.0.202', '080798', '1'), bg = alarm_color)
...
HX8100_2_1 = Button(lbl_HX8100_2, text="1-48", width = 10, command = lambda: installation_card('HX8100', '080799', '2'), bg = alarm_color)
HX8100_2_1.place(x=50, y=0)
HX8100_2_2 = Button(lbl_HX8100_2, text="49-96", width = 10, command = lambda: installation_card('HX8100', '080799', '2'), bg = alarm_color)
HX8100_2_2.place(x=145, y=0)
HX8100_2_PC = Button(lbl_HX8100_2, text="ПК", width = 3, command = lambda: PC_card('PC2', '192.168.0.163', '080799', '2'), bg = alarm_color)
...
SY8125_1 = Button(lbl_SY8125_1, text="1-24", width = 10, command = lambda: installation_card('SY8125', '703143', '3'), bg = alarm_color)
SY8125_1.place(x=50, y=0)
SY8125_1_PC = Button(lbl_SY8125_1, text="ПК", width = 3, command = lambda: PC_card('PC3', '192.168.0.242', '703143', '3'), bg = alarm_color)
...
SY8125_2 = Button(lbl_SY8125_2, text="1-24", width = 10, command = lambda: installation_card('SY8125', '703146', '4'), bg = alarm_color)
SY8125_2.place(x=50, y=30)
SY8125_2_PC = Button(lbl_SY8125_2, text="ПК", width = 3, command = lambda: PC_card('PC4', '192.168.0.97', '703146', '4'), bg = alarm_color)
...
UAPS1M_5 = Button(lbl_UAPS1M_5, text="Уст.", width = 3, command = lambda: installation_card('UAPS-1M', '000000', '5'), bg = alarm_color)
UAPS1M_5.place(x=20, y=00)
UAPS1M_5_1 = Button(lbl_UAPS1M_5, text="1-6", width = 3, command = lambda: installation_card('UAPS-1M', '000000', '5'), bg = alarm_color)
...
UAPS1M_6 = Button(lbl_UAPS1M_6, text="Уст.", width = 3, command = lambda: installation_card('UAPS-1M', '102', '6'), bg = alarm_color)
UAPS1M_6.place(x=20, y=00)
UAPS1M_6_1 = Button(lbl_UAPS1M_6, text="1-6", width = 3, command = lambda: installation_card('UAPS-1M', '102', '6'), bg = alarm_color)
UAPS1M_6_1.place(x=40, y=30)
UAPS1M_6_PC = Button(lbl_UAPS1M_6, text="ПК", width = 3, command = lambda: PC_card('PC6', '192.168.0.169', '102', '6'), bg = alarm_color)
...
UAPS1M_7 = Button(lbl_UAPS1M_7, text="Уст.", width = 3, command = lambda: installation_card('UAPS-1M', '61207', '7'), bg = alarm_color)
UAPS1M_7.place(x=20, y=00)
UAPS1M_7_1 = Button(lbl_UAPS1M_7, text="1-6", width = 3, command = lambda: installation_card('UAPS-1M', '61207', '7'), bg = alarm_color)
UAPS1M_7_1.place(x=40, y=30)
UAPS1M_7_PC = Button(lbl_UAPS1M_7, text="ПК", width = 3, command = lambda: PC_card('PC7', '192.168.0.37', '61207', '7'), bg = alarm_color)
...
UAPS1M_8 = Button(lbl_UAPS1M_8, text="Уст.", width = 3, command = lambda: installation_card('UAPS-1M', '109', '8'), bg = alarm_color)
UAPS1M_8.place(x=20, y=00)
UAPS1M_8_1 = Button(lbl_UAPS1M_8, text="1-6", width = 3, command = lambda: installation_card('UAPS-1M', '109', '8'), bg = alarm_color)
UAPS1M_8_1.place(x=40, y=30)
UAPS1M_8_PC = Button(lbl_UAPS1M_8, text="ПК", width = 3, command = lambda: PC_card('PC8', '192.168.0.17', '109', '8'), bg = alarm_color)
...
UAPS1M_9 = Button(lbl_UAPS1M_9, text="Уст.", width = 3, command = lambda: installation_card('UAPS-1M', '050908', '9'), bg = alarm_color)
UAPS1M_9.place(x=20, y=00)
UAPS1M_9_1 = Button(lbl_UAPS1M_9, text="1-6", width = 3, command = lambda: installation_card('UAPS-1M', '050908', '9'), bg = alarm_color)
UAPS1M_9_1.place(x=40, y=30)
UAPS1M_9_PC = Button(lbl_UAPS1M_9, text="ПК", width = 3, command = lambda: PC_card('PC9', '192.168.0.40', '050908', '9'), bg = alarm_color)
...
HX8300_10_1 = Button(lbl_HX8300_10, text="1-\n24", width = 3, height = 3, command = lambda: installation_card('HX8300','0807102', '10'), bg = alarm_color)
HX8300_10_1.place(x=5, y=30)
HX8300_10_2 = Button(lbl_HX8300_10, text="25-\n48", width = 3, height = 3, command = lambda: installation_card('HX8300','0807102', '10'), bg = alarm_color)
HX8300_10_2.place(x=5, y=95)
HX8300_10_3 = Button(lbl_HX8300_10, text="49-\n72", width = 3, height = 3, command = lambda: installation_card('HX8300','0807102', '10'), bg = alarm_color)
HX8300_10_3.place(x=5, y=160)
HX8300_10_4 = Button(lbl_HX8300_10, text="73-\n96", width = 3, height = 3, command = lambda: installation_card('HX8300','0807102', '10'), bg = alarm_color)
...
HX8300_11_1 = Button(lbl_HX8300_11, text="1-\n24", width = 3, height = 3, command = lambda: installation_card('HX8300','0807103', '11'), bg = alarm_color)
HX8300_11_1.place(x=5, y=30)
HX8300_11_2 = Button(lbl_HX8300_11, text="25-\n48", width = 3, height = 3, command = lambda: installation_card('HX8300','0807103', '11'), bg = alarm_color)
HX8300_11_2.place(x=5, y=95)
HX8300_11_3 = Button(lbl_HX8300_11, text="49-\n72", width = 3, height = 3, command = lambda: installation_card('HX8300','0807103', '11'), bg = alarm_color)
HX8300_11_3.place(x=5, y=160)
HX8300_11_4 = Button(lbl_HX8300_11, text="73-\n96", width = 3, height = 3, command = lambda: installation_card('HX8300','0807103', '11'), bg = alarm_color)
...
CL3005_1_1 = Button(lbl_CL3005_1, text="1-12", width = 10, command = lambda: installation_card('CL3005-24','3028', '12'), bg = alarm_color)
CL3005_1_1.place(x=10, y=15)
CL3005_1_2 = Button(lbl_CL3005_1, text="13-24", width = 10, command = lambda: installation_card('CL3005-24','3028', '12'), bg = alarm_color)
CL3005_1_2.place(x=105, y=15)
CL3005_1_ST = Button(lbl_CL3005_1, text="Уст.", width = 3, command = lambda: installation_card('CL3005-24','3028', '12'), bg = alarm_color)
CL3005_1_ST.place(x=200, y=30)
CL3005_1_PC = Button(lbl_CL3005_1, text="ПК", width = 3, command = lambda: PC_card('PC12', '192.168.0.185','3028', '12'), bg = alarm_color)
...
CL3005_2_1 = Button(lbl_CL3005_2, text="1-12", width = 10, command = lambda: installation_card('CL3005-24','3042', '13'), bg = alarm_color)
CL3005_2_1.place(x=10, y=15)
CL3005_2_2 = Button(lbl_CL3005_2, text="13-24", width = 10, command = lambda: installation_card('CL3005-24','3042', '13'), bg = alarm_color)
CL3005_2_2.place(x=105, y=15)
CL3005_2_ST = Button(lbl_CL3005_2, text="Уст.", width = 3, command = lambda: installation_card('CL3005-24','3042', '13'), bg = alarm_color)
CL3005_2_ST.place(x=200, y=30)
CL3005_2_PC = Button(lbl_CL3005_2, text="ПК", width = 3, command = lambda: PC_card('PC13', '192.168.0.253','3042', '13'), bg = alarm_color)
...
CL1001_1_1 = Button(lbl_CL1001_1, text="1-24", width = 10, command = lambda: installation_card('CL1001','1009', '14'), bg = alarm_color)
CL1001_1_1.place(x=50, y=15)
CL1001_1_ST = Button(lbl_CL1001_1, text="Уст.", width = 3, command = lambda: installation_card('CL1001','1009', '14'), bg = alarm_color)
CL1001_1_ST.place(x=10, y=0)
CL1001_1_PC = Button(lbl_CL1001_1, text="ПК", width = 3, command = lambda: PC_card('PC14', '192.168.0.201','1009', '14'), bg = alarm_color)
...
CL1001_2_1 = Button(lbl_CL1001_2, text="1-24", width = 10, command = lambda: installation_card('CL1001','1008', '15'), bg = alarm_color)
CL1001_2_1.place(x=10, y=15)
CL1001_2_ST = Button(lbl_CL1001_2, text="Уст.", width = 3, command = lambda: installation_card('CL1001','1008', '15'), bg = alarm_color)
CL1001_2_ST.place(x=110, y=30)
CL1001_2_PC = Button(lbl_CL1001_2, text="ПК", width = 3, command = lambda: PC_card('PC15', '192.168.0.47','1008', '15'), bg = alarm_color)
...
SY8125_3 = Button(lbl_SY8125_3, text="1-24", width = 10, command = lambda: installation_card('SY8125', '703154', '16'), bg = alarm_color)
SY8125_3.place(x=50, y=0)
SY8125_3_PC = Button(lbl_SY8125_3, text="ПК", width = 3, command = lambda: PC_card('PC16', '192.168.0.155', '703154', '16'), bg = alarm_color)
...
SY8125_4 = Button(lbl_SY8125_4, text="1-24", width = 10, command = lambda: installation_card('SY8125', '703152', '17'), bg = alarm_color)
SY8125_4.place(x=50, y=0)
SY8125_4_PC = Button(lbl_SY8125_4, text="ПК", width = 3, command = lambda: PC_card('PC17', '192.168.0.197', '703152', '17'), bg = alarm_color)
...
SY8125_5 = Button(lbl_SY8125_5, text="1-24", width = 10, command = lambda: installation_card('SY8125', '703153', '18'), bg = alarm_color)
SY8125_5.place(x=50, y=0)
SY8125_5_PC = Button(lbl_SY8125_5, text="ПК", width = 3, command = lambda: PC_card('PC18', '192.168.0.113', '703153', '18'), bg = alarm_color)
...
SY8125_6 = Button(lbl_SY8125_6, text="1-24", width = 10, command = lambda: installation_card('SY8125', '703151', '19'), bg = alarm_color)
SY8125_6.place(x=50, y=0)
SY8125_6_PC = Button(lbl_SY8125_6, text="ПК", width = 3, command = lambda: PC_card('PC19', '192.168.0.134', '703151', '19'), bg = alarm_color)
...
CL3005_3_1 = Button(lbl_CL3005_3, text="1-12", width = 10, command = lambda: installation_card('CL3005-24','3035', '20'), bg = alarm_color)
CL3005_3_1.place(x=40, y=15)
CL3005_3_2 = Button(lbl_CL3005_3, text="13-24", width = 10, command = lambda: installation_card('CL3005-24','3035', '20'), bg = alarm_color)
CL3005_3_2.place(x=135, y=15)
CL3005_3_ST = Button(lbl_CL3005_3, text="Уст.", width = 3, command = lambda: installation_card('CL3005-24','3035', '20'), bg = alarm_color)
CL3005_3_ST.place(x=0, y=0)
CL3005_3_PC = Button(lbl_CL3005_3, text="ПК", width = 3, command = lambda: PC_card('PC20', '192.168.0.14','3035', '20'), bg = alarm_color)
...
CL3005_4_1 = Button(lbl_CL3005_4, text="1-12", width = 10, command = lambda: installation_card('CL3005-24','3036', '21'), bg = alarm_color)
CL3005_4_1.place(x=0, y=15)
CL3005_4_2 = Button(lbl_CL3005_4, text="13-24", width = 10, command = lambda: installation_card('CL3005-24','3036', '21'), bg = alarm_color)
CL3005_4_2.place(x=95, y=15)
CL3005_4_ST = Button(lbl_CL3005_4, text="Уст.", width = 3, command = lambda: installation_card('CL3005-24','3036', '21'), bg = alarm_color)
CL3005_4_ST.place(x=190, y=30)
CL3005_4_PC = Button(lbl_CL3005_4, text="ПК", width = 3, command = lambda: PC_card('PC21', '192.168.0.13','3036', '21'), bg = alarm_color)
...
CL3005_5_1 = Button(lbl_CL3005_5, text="1-12", width = 10, command = lambda: installation_card('CL3005-24','3032', '22'), bg = alarm_color)
CL3005_5_1.place(x=50, y=15)
CL3005_5_2 = Button(lbl_CL3005_5, text="13-24", width = 10, command = lambda: installation_card('CL3005-24','3032', '22'), bg = alarm_color)
CL3005_5_2.place(x=145, y=15)
CL3005_5_ST = Button(lbl_CL3005_5, text="Уст.", width = 3, command = lambda: installation_card('CL3005-24','3032', '22'), bg = alarm_color)
CL3005_5_ST.place(x=10, y=0)
CL3005_5_PC = Button(lbl_CL3005_5, text="ПК", width = 3, command = lambda: PC_card('PC22', '192.168.0.200','3032', '22'), bg = alarm_color)
...
CL1001_3_1 = Button(lbl_CL1001_2, text="1-12", width = 6, command = lambda: installation_card('CL1001','1015', '23'), bg = alarm_color)
CL1001_3_1.place(x=90, y=0)
CL1001_3_2 = Button(lbl_CL1001_2, text="13-24", width = 6, command = lambda: installation_card('CL1001','1015', '23'), bg = alarm_color)
CL1001_3_2.place(x=150, y=0)
CL1001_3_ST = Button(lbl_CL1001_2, text="Уст.", width = 3, command = lambda: installation_card('CL1001','1015', '23'), bg = alarm_color)
CL1001_3_ST.place(x=10, y=0)
CL1001_3_PC = Button(lbl_CL1001_2, text="ПК", width = 3, command = lambda: PC_card('PC23', '192.168.0.100','1015', '23'), bg = alarm_color)
...
CL1005_1_1 = Button(lbl_CL1005_1, text="1-24", width = 6, command = lambda: installation_card('CL1001','1012', '24'), bg = alarm_color)
CL1005_1_1.place(x=110, y=0)
CL1005_1_2 = Button(lbl_CL1005_1, text="13-48", width = 6, command = lambda: installation_card('CL1001','1012', '24'), bg = alarm_color)
CL1005_1_2.place(x=10, y=0)
CL1005_1_ST = Button(lbl_CL1005_1, text="Уст.", width = 3, command = lambda: installation_card('CL1001','1012', '24'), bg = alarm_color)
CL1005_1_ST.place(x=170, y=0)
CL1005_1_PC = Button(lbl_CL1005_1, text="ПК", width = 3, command = lambda: PC_card('PC24', '192.168.0.245','1012', '24'), bg = alarm_color)
...
CL3005_6_1 = Button(lbl_CL3005_6, text="1-12", width = 10, command = lambda: installation_card('CL3005-24','3044', '25'), bg = alarm_color)
CL3005_6_1.place(x=40, y=15)
CL3005_6_2 = Button(lbl_CL3005_6, text="13-24", width = 10, command = lambda: installation_card('CL3005-24','3044', '25'), bg = alarm_color)
CL3005_6_2.place(x=135, y=15)
CL3005_6_ST = Button(lbl_CL3005_6, text="Уст.", width = 3, command = lambda: installation_card('CL3005-24','3044', '25'), bg = alarm_color)
CL3005_6_ST.place(x=0, y=0)
CL3005_6_PC = Button(lbl_CL3005_6, text="ПК", width = 3, command = lambda: PC_card('PC25', '192.168.0.247','3044', '25'), bg = alarm_color)
...
SY8126_1_1 = Button(lbl_SY8126_1, text="1-12", width = 10, command = lambda: installation_card('SY8126','704202', '26'), bg = alarm_color)
SY8126_1_1.place(x=50, y=15)
SY8126_1_2 = Button(lbl_SY8126_1, text="13-24", width = 10, command = lambda: installation_card('SY8126','704202', '26'), bg = alarm_color)
SY8126_1_2.place(x=145, y=15)
SY8126_1_ST = Button(lbl_SY8126_1, text="Уст.", width = 3, command = lambda: installation_card('SY8126','704202', '26'), bg = alarm_color)
SY8126_1_ST.place(x=10, y=0)
SY8126_1_PC = Button(lbl_SY8126_1, text="ПК", width = 3, command = lambda: PC_card('PC26', '192.168.0.112','704202', '26'), bg = alarm_color)
...
SY8126_2_1 = Button(lbl_SY8126_2, text="1-12", width = 10, command = lambda: installation_card('SY8126','704203', '27'), bg = alarm_color)
SY8126_2_1.place(x=10, y=15)
SY8126_2_2 = Button(lbl_SY8126_2, text="13-24", width = 10, command = lambda: installation_card('SY8126','704203', '27'), bg = alarm_color)
SY8126_2_2.place(x=105, y=15)
SY8126_2_ST = Button(lbl_SY8126_2, text="Уст.", width = 3, command = lambda: installation_card('SY8126','704203', '27'), bg = alarm_color)
SY8126_2_ST.place(x=200, y=30)
SY8126_2_PC = Button(lbl_SY8126_2, text="ПК", width = 3, command = lambda: PC_card('PC27', '192.168.0.16','704203', '27'), bg = alarm_color)
...
SY8126_3_1 = Button(lbl_SY8126_3, text="1-12", width = 10, command = lambda: installation_card('SY8126','704205', '28'), bg = alarm_color)
SY8126_3_1.place(x=50, y=15)
SY8126_3_2 = Button(lbl_SY8126_3, text="13-24", width = 10, command = lambda: installation_card('SY8126','704205', '28'), bg = alarm_color)
SY8126_3_2.place(x=145, y=15)
SY8126_3_ST = Button(lbl_SY8126_3, text="Уст.", width = 3, command = lambda: installation_card('SY8126','704205', '28'), bg = alarm_color)
SY8126_3_ST.place(x=10, y=0)
SY8126_3_PC = Button(lbl_SY8126_3, text="ПК", width = 3, command = lambda: PC_card('PC28', '192.168.0.101','704205', '28'), bg = alarm_color)
...
SY8126_2_1 = Button(lbl_SY8126_2, text="1-12", width = 10, command = lambda: installation_card('SY8126','704204', '29'), bg = alarm_color)
SY8126_2_1.place(x=10, y=15)
SY8126_2_2 = Button(lbl_SY8126_2, text="13-24", width = 10, command = lambda: installation_card('SY8126','704204', '29'), bg = alarm_color)
SY8126_2_2.place(x=105, y=15)
SY8126_2_ST = Button(lbl_SY8126_2, text="Уст.", width = 3, command = lambda: installation_card('SY8126','704204', '29'), bg = alarm_color)
SY8126_2_ST.place(x=200, y=30)
SY8126_2_PC = Button(lbl_SY8126_2, text="ПК", width = 3, command = lambda: PC_card('PC29', '000.000.000.000','704204', '29'), bg = alarm_color)
SY8126_2_PC.place(x=200, y=0)
...
CL3005_7_1 = Button(lbl_CL3005_7, text="1-12", width = 10, command = lambda: installation_card('CL3005-24','3030', '30'), bg = alarm_color)
CL3005_7_1.place(x=50, y=15)
CL3005_7_2 = Button(lbl_CL3005_7, text="13-24", width = 10, command = lambda: installation_card('CL3005-24','3030', '30'), bg = alarm_color)
CL3005_7_2.place(x=145, y=15)
CL3005_7_ST = Button(lbl_CL3005_7, text="Уст.", width = 3, command = lambda: installation_card('CL3005-24','3030', '30'), bg = alarm_color)
CL3005_7_ST.place(x=10, y=0)
CL3005_7_PC = Button(lbl_CL3005_7, text="ПК", width = 3, command = lambda: PC_card('PC30', '192.168.0.180','3030', '30'), bg = alarm_color)
...
CL3005_8_1 = Button(lbl_CL3005_8, text="1-12", width = 10, command = lambda: installation_card('CL3005-24','3029', '31'), bg = alarm_color)
CL3005_8_1.place(x=10, y=15)
CL3005_8_2 = Button(lbl_CL3005_8, text="13-24", width = 10, command = lambda: installation_card('CL3005-24','3029', '31'), bg = alarm_color)
CL3005_8_2.place(x=105, y=15)
CL3005_8_ST = Button(lbl_CL3005_8, text="Уст.", width = 3, command = lambda: installation_card('CL3005-24','3029', '31'), bg = alarm_color)
CL3005_8_ST.place(x=200, y=30)
CL3005_8_PC = Button(lbl_CL3005_8, text="ПК", width = 3, command = lambda: PC_card('PC31', '192.168.0.111','3029', '31'), bg = alarm_color)
...
Merkury_210 = Button(lbl_Merkury_210, text="1-6", width = 3, command = lambda: installation_card('Merkury_210','025', '32'), bg = alarm_color)
...
Merkury_210 = Button(lbl_Merkury_210, text="1-6", width = 3, command = lambda: installation_card('Merkury_210','018', '33'), bg = alarm_color)
Merkury_210.place(x=10, y=0)
Hovertip(Merkury_210, ['Merkury_210', 'SN025'])
...
Functional_3ph_1 = Button(lbl_Functional_3ph_1, text="1", width = 3, command = lambda: installation_card('Functional_3ph', '000001', '34'), bg = alarm_color)
Functional_3ph_1.place(x=10, y=0)
Functional_3ph_PC_1 = Button(lbl_Functional_3ph_1, text="ПК", width = 3, command = lambda: PC_card('PC34', '192.168.194.19', '000001', '34'), bg = alarm_color)
...
Functional_3ph_2 = Button(lbl_Functional_3ph_2, text="1", width = 3, command = lambda: installation_card('Functional_3ph','000002', '35'), bg = alarm_color)
Functional_3ph_2.place(x=10, y=0)
Functional_3ph_PC_2 = Button(lbl_Functional_3ph_2, text="ПК", width = 3, command = lambda: PC_card('PC35', '000.000.000.000','000002', '35'), bg = alarm_color)
...
Functional_1ph_1 = Button(lbl_Functional_1ph_1, text="1", width = 3, command = lambda: installation_card('Functional_1ph','061101401', '36'), bg = alarm_color)
Functional_1ph_PC_3 = Button(lbl_Functional_1ph_1, text="ПК", width = 3, command = lambda: PC_card('PC36', '000.000.000.000','061101401', '36'), bg = alarm_color)
...
Functional_1ph_2 = Button(lbl_Functional_1ph_2, text="1", width = 3, command = lambda: installation_card('Functional_1ph','000004', '37'), bg = alarm_color)
Functional_1ph_2.place(x=10, y=0)
Functional_1ph_2_PC_4 = Button(lbl_Functional_1ph_2, text="ПК", width = 3, command = lambda: PC_card('PC37', '000.000.000.000','000004', '37'), bg = alarm_color)
